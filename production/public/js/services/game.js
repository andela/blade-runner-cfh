...
angular.module('mean.system').factory('game', ['$rootScope', 'socket', '$timeout', function ($rootScope, socket, $timeout) {
  var game = {
  ...
  var addToNotificationQueue = function addToNotificationQueue(msg) {
