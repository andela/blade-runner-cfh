...
angular.module('mean.system').controller('GameController', ['$rootScope', '$scope', 'game', '$timeout', '$location', 'MakeAWishFactsService', function ($rootScope, $scope, game, $timeout, $location, MakeAWishFactsService) {
  ...
  $rootScope.$on('maxPlayersReached', function () {
