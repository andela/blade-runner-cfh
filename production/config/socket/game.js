...
var guestNames = ["Disco Potato", "Silver Blister", "Insulated Mustard", "Funeral Flapjack", "Toenail", "Urgent Drip", "Raging Bagel", "Aggressive Pie", "Loving Spoon", "Swollen Node", "The Spleen", "Dingle Dangle"];
...
Game.prototype.prepareGame = function () {
  ...
  var self = this;
  async.parallel([this.getQuestions, this.getAnswers], function (err, results) {
    if (err) {
      console.log(err);
    }
...
Game.prototype.dealAnswers = function (maxAnswers) {
  ...
  var storeAnswers = function storeAnswers(err, data) {
    self.answers = data;
  };
